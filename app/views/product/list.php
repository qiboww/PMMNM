            ...
            <div class="card h-100 shadow-sm card-custom overflow-hidden">
                ...
                <div class="card-footer bg-white border-top-0 p-3 pt-0">
                    <div class="row g-2 mb-2">
                        <div class="col-6">
                            <a href="/Product/show/<?php echo $product->id; ?>" class="btn btn-outline-primary w-100 fw-medium btn-sm"><i class="bi bi-eye"></i> Xem</a>
                        </div>
                        <div class="col-6">
                            <a href="/Cart/add/<?php echo $product->id; ?>" class="btn btn-warning w-100 fw-bold btn-sm"><i class="bi bi-cart-plus"></i> Mua</a>
                        </div>
                    </div>
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <a href="/Product/edit/<?php echo $product->id; ?>" class="btn btn-outline-secondary w-100 fw-medium btn-sm"><i class="bi bi-pencil-square"></i></a>
                        </div>
                        <div class="col-6">
                            <a href="/Product/delete/<?php echo $product->id; ?>" class="btn btn-outline-danger w-100 fw-medium btn-sm" onclick="return confirm('Chắc chắn xóa?');"><i class="bi bi-trash3"></i></a>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
