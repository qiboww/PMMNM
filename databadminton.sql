...
-- Dumping structure for table badminton_store.carts
...
-- Dumping data for table badminton_store.carts: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `payment_method` enum('cod','transfer','momo') DEFAULT 'cod',
  `payment_status` enum('unpaid','paid') DEFAULT 'unpaid',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table badminton_store.orders: ~4 rows (approximately)
INSERT INTO `orders` (`id`, `user_id`, `customer_name`, `customer_phone`, `customer_address`, `total_price`, `created_at`, `status`, `payment_method`, `payment_status`) VALUES
	(1, NULL, 'Quốc Bảo', '0902815729', '611 Thống Nhất, Phường An Hội Đông, TP.HCM', 7400000.00, '2026-06-03 01:23:36', 'completed', 'cod', 'unpaid'),
	(2, NULL, 'Quốc Trung', '0902815722', 'Gò vấp', 7800000.00, '2026-06-03 01:56:27', 'pending', 'cod', 'unpaid'),
	(3, NULL, 'Quốc Bảo', '0902815729', 'Bình Thạnh', 5700000.00, '2026-06-03 02:22:53', 'processing', 'cod', 'unpaid'),
	(4, NULL, 'Hân', '0902815742', 'xyz', 6600000.00, '2026-06-10 03:32:10', 'pending', 'cod', 'unpaid'),
	(5, 3, 'Bảo', '0902815729', 'Thống Nhất', 150000.00, '2026-06-10 03:40:19', 'processing', 'cod', 'unpaid');
...
-- Dumping data for table badminton_store.order_details: ~8 rows (approximately)
...
-- Dumping data for table badminton_store.product: ~0 rows (approximately)
